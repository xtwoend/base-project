...
<section class="content">
    <div class="box box-primary">
        ...
        <form role="form" method="POST" action="{{ route('setting.users.store') }}">
            @csrf
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input name="email" type="email" class="form-control" placeholder="email@domain.com" value="{{ old('email') }}">
                    @error('email')
                        <p class="help-block txt-red">{{ $message }}</p>
                    @enderror
                </div>
